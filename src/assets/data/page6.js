...
export default [
    ...
    },
    {
        name:'Node.js',
        link:'https://github.com/js-cookie/js-cookie',
        icon:'https://nodejs.org/static/favicon.png',
        desc:'Node.js® 是一个基于 Chrome V8 引擎的 JavaScript 运行库',
        type:{
            '中文站':'http://nodejs.cn',
    ...
    {
        name:'SVN',
        link:'http://subversion.apache.org/packages.html',
